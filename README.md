# nvim-treesitter-queries-gotmpl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gotmpl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gotmpl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gotmpl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gotmpl",
...
- [ ] Changes are scoped to `gotmpl` — do not include files for other languages
